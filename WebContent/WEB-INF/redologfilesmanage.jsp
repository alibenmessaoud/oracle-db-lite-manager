	...
	<div
		...
		<div style="padding-bottom: 2px;">
			<div style="display: inline-block; float: left;">
				<h2>Redo group Logfiles List</h2>
			</div>
			<div style="display: inline-block; float: right; padding-top: 4px;">
				<a href="redoLogfilesGroupAdd" class="btn btn-primary">Create Log group</a> 
				<a href="redoLogfilesMemberAdd" class="btn btn-primary">Create Log member</a>
			</div>
		</div>
		<br> <br>
		<div>
