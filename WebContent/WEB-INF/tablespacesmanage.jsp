...
<title>Tablespace Manage · Oracle DB Lite Manager : ODBLM</title>
	...
	<div
		...
		<div style="padding-bottom: 2px;">
			<div style="display: inline-block; float: left;">
				<h2>Tablespaces List</h2>
			</div>
			<div style="display: inline-block; float: right; padding-top: 4px;">
				<a href="tablespaceAdd" class="btn btn-primary">Create Tablespace</a>
			</div>
		</div>
		<br> <br>
		<div>
