...
<title>Display User : ${ user.username } · Oracle DB Lite
	Manager : ODBLM</title>
...
<body>
	...
	<div
		...
		<div class="alert alert-success">
			...
			<%
				String attribut = (String) request.getAttribute("success");
		...
		<div style="padding-bottom: 2px;">
			...
			<div style="display: inline-block; float: right; padding-top: 4px;">
				<a class="btn btn-primary" href="userEdit?userID=${ user.username }">Edit
					User</a>
			</div>
		</div>
		<br> <br>
		...
		<div>
			<form method="post" action="user_add_process">
				<table width="958" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">User Name
								: </label></td>
					...
					<tr>
						<td width="200" align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Profile :
						</label></td>
						<td width="368" align="left">${ user.getProfile() }</td>
						<td width="390" align="left">&nbsp;</td>
					</tr>
					<tr>
						<td width="200" align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Authentication
								: </label></td>
						<td width="368" align="left">${ user.getAuthentication() }</td>
						<td width="390" align="left">&nbsp;</td>
					</tr>
					<tr>
						<td align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Default
								Tablespace : </label></td>
						<td align="left">${ user.getDefaultTableSpace() }</td>
						<td align="left">&nbsp;</td>
					</tr>
					<tr>
						<td align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Temporary
								Tablespace : </label></td>
						<td align="left">${ user.getTemporaryTableSpace() }</td>
						<td align="left">&nbsp;</td>
					</tr>
					<tr>
						<td align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Status : </label></td>
						<td align="left">${ user.getStatus() }</td>
						<td align="left">&nbsp;</td>
					</tr>
					<tr>
						<td align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Password
								Expire : </label></td>
						<td align="left">${ user.getExpire() }</td>
						<td align="left">&nbsp;</td>
					</tr>
				</table>
			</form>
