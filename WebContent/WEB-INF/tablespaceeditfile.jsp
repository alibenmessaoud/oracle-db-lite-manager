	...
	<div
		...
		<div id="bread_crumbs" style="margin-bottom: -20px;">
			<ul class="breadcrumb">
				...
				<li class="active">Edit ${tablespaceName} Tablespace datafiles</li>
			</ul>
		</div>
		<!-- End breadcrumbs
		================================================== -->
		...
		<div style="padding-bottom: 2px;">
			<div style="display: inline-block; float: left;">
				<h2>Tablespace edit datafile ${FILE_NAME}</h2>
			</div>
		...
		<div>
			<form method="post" action="tablespaceAddProcess">
				<table width="958" border="0" cellspacing="0" cellpadding="0">
							...
							<table width="525" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td colspan="3"><input type="text" id="p_scnt"
										name="smallFileName" value="${FILE_NAME}"
										placeholder="Datafile Tablespace Name" class="input-xlarge"
										style="width: 363px;" />
									<input type="hidden" value="${tablespaceName}" name="tablespace_name" />	
									</td>
									<td width="56" align="left">&nbsp;</td>
								</tr>
								<tr>
									<td width="184" colspan="2"><input type="text"
										id="p_scnt2" name="smallFileSize" value=""
										placeholder="Datafile Tablespace Size" class="input-xlarge" /></td>
								...
								<tr>
									<td><label class="checkbox inline"> <input
											type="checkbox" id="reuse" value="reuse" name="reuse"><span
									...
									<td colspan="2"><table width="201" border="0"
											...
											<tr>
												...
												<td width="58"><label class="radio"> <input
														type="radio" name="autoextend" value="on"> <span
														class="metro-radio">On</span>
												</label></td>
												<td width="58"><label class="radio"> <input
								...
								<tr>
									<td width="144" colspan="2"><input type="text"
										id="p_scnt2" name="smallFileSizeNEXT" value=""
										placeholder="Next Datafile Tablespace Size"
										class="input-xlarge" /></td>
									<td width="155"><select name="smallFileSizeNEXTUnit"
										class="input-medium" id="smallFileSizeNEXTUnit">
											<option value="K">K</option>
											<option value="M">M</option>
											<option value="G">G</option>
											<option value="T">T</option>
								...
								<tr>
									<td width="144" colspan="2"><input type="text"
										id="p_scnt2" name="smallFileSizeMAXSIZE " value=""
										placeholder="Datafile Tablespace max Size"
										class="input-xlarge" /></td>
									<td width="155"><select name="smallFileSizeMAXSIZEUnit"
										class="input-medium" id="smallFileSizeMAXSIZEUnit">
											<option value="K">K</option>
											<option value="M">M</option>
											<option value="G">G</option>
											<option value="T">T</option>
					...
					<tr>
						<td width="958" align="right" valign="top">
