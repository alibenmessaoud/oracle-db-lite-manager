...
<title>Execute Query · Oracle DB Lite Manager : ODBLM</title>
...
<body>
	...
	<div
		...
		<div>
			<form action="queryProcess" method="post" id="formQuery">
				<textarea id="formQuery" class="span10" style="height: 120px;"
					name="query">${query }</textarea>
				<div>
					<input type="submit" class="btn" value="Run"
						style="float: right; margin-left: 6px;" /> <input type="reset"
						onclick="document.getElementById('formQuery').value='';"
						class="btn" value="Clear" style="float: right" />
				</div>
			</form>
		</div>
	</div>
