...
<title>Add log file member - Oracle DB Lite Manager : ODBLM</title>
	...
	<div
		...
		<div id="bread_crumbs" style="margin-bottom: -20px;">
			<ul class="breadcrumb">
				...
				<li><a href="redoManage">Manage redo Logfiles</a> <span class="divider">/</span></li>
				<li>Create Redo logfile member</li>
			</ul>
		</div>
		<!-- End breadcrumbs
		================================================== -->
		...
		<div style="padding-bottom: 2px;">
			<div style="display: inline-block; float: left;">
				<h2>Create Redo logfile member</h2>
			</div>
		...
		<div>
			<form method="post" action="redoLogfilesMemberAdd" name="form"
				target="_parent">
				<table align="center">

					<tr>
						<td><label style="padding-right: 10px; padding-top: 4px;">File
								name</label></td>
						<td colspan="2"><input type="text" name="file_name"
							class="input-large"></td>
					</tr>
					<tr>
						<td width="131"><label
							style="padding-right: 10px; padding-top: 4px;">Group name</label></td>
						<td width="236" colspan="2"><input type="text"
							name="group_name" class="input-large"></td>
					</tr>
					<tr>
						<td colspan="2" align="left"><input
							style="float: right; padding-left: 4px;" type="submit"
							value="Save changes"> <input
							style="float: right; padding-left: 4px;" type="reset"
							value="Cancel"></td>
					</tr>
				</table>
			</form>
