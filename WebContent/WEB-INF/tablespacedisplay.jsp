	...
	<div
		...
		<div id="bread_crumbs" style="margin-bottom: -20px;">
			<ul class="breadcrumb">
				...
				<li><a href="tablespacesManage">Manage Tablespaces</a> <span
					class="divider">/</span></li>
				<li class="active">${tablespaceName} Tablespace Detail</li>
			</ul>
		</div>
		<!-- End breadcrumbs
		================================================== -->
		...
		<div style="padding-bottom: 2px;">
			<div style="display: inline-block; float: left;">
				<h2>${tablespaceName} Tablespace detail</h2>
			</div>
			<div style="display: inline-block; float: right; padding-top: 4px;">
				<a class="btn btn-primary"
					href="tablespaceEdit?tablespaceID=${ tablespaceName }">Edit
					Tablespace</a>
			</div>
		</div>
		<br> <br>
		...
		<div>
			<table align="left" width="958" border="0" cellspacing="0"
				cellpadding="0">
				${tablespace}
			...
			<h2>${tablespaceName} Tablespace Datafiles</h2>
