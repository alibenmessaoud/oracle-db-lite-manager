...
<title>Home · Oracle DB Lite Manager : ODBLM</title>
...
<body>
	...
	<div
		...
		<a href="tablespacesUndoManage">
			<div
				style="height: 128px; width: 300px; border: 2px solid #F2CE9F; float: left; background: #F58D00; margin: 30px 22px 0px 0px;">
				<div style="height: 128px; width: 128px; float: left;">
					<img src="content/img/undo.png" />
				</div>
				<div
					style="width: 128px; height: 128px; float: left; padding: 10px; padding-top: 10px; color: #FFF;">
					<h2>Manage UNDO Tablespaces</h2>
				</div>
			</div>
		</a> <a href="tablespacesManage">
			<div
				style="height: 128px; width: 300px; border: 2px solid #A6DAED; float: left; background: #00AEEF; margin: 30px 22px 0px 0px;">
				<div style="height: 128px; width: 128px; float: left;">
					<img src="content/img/tablespace.png" />
				</div>
				<div
					style="width: 128px; height: 128px; float: left; padding: 10px; padding-top: 30px; color: #FFF;">
					<h2>Manage Tablespaces</h2>
				</div>
			</div>
		</a> <a href="redoManage">
			<div
				style="height: 128px; width: 300px; border: 2px solid #B967EF; float: left; background: #9A15F2; margin: 30px 0px 0px 0px;">
				<div style="height: 128px; width: 128px; float: left;">
					<img src="content/img/redo.png" />
				</div>
				<div
					style="width: 128px; height: 128px; float: left; padding: 10px; padding-top: 10px; color: #FFF;">
					<h2>Manage REDO Logfiles</h2>
				</div>
			</div>
		</a> <a href="queryManage">
			<div
				style="height: 128px; width: 300px; border: 2px solid #D8D8D8; float: left; background: #959595; margin: 30px 22px 0px 0px;">
				<div style="height: 128px; width: 128px; float: left;">
					<img src="content/img/query.png" />
				</div>
				<div
					style="width: 128px; height: 128px; float: left; padding: 10px; padding-top: 30px; color: #FFF;">
					<h2>Execute Query</h2>
		...
		</a> <a href="usersManage">
			<div
				style="height: 128px; width: 300px; border: 2px solid #62BC34; float: left; background: #4F9B2B; margin: 30px 22px 0px 0px;">
				<div style="height: 128px; width: 128px; float: left;">
			...
			<div
				style="height: 128px; width: 300px; border: 2px solid #E26F74; float: left; background: #E5363C; margin: 30px 0px 0px 0px;">
				<div style="height: 128px; width: 128px; float: left;">
					<img src="content/img/Home_Network.png" />
				</div>
				<div
					style="width: 128px; height: 128px; float: left; padding: 10px; padding-top: 50px; color: #FFF;">
					<h2>Go Home</h2>
				</div>
			</div>
		</a>
	...
	<div
		style="width: 958px; margin-left: auto; margin-right: auto; padding-top: 300px;">
