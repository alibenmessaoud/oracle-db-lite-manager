...
<title>Edit User : ${ user.username } · Oracle DB Lite Manager :
	ODBLM</title>
<meta name="robots" content="noindex, nofollow">
<meta name="description"
	content="Le projet consiste ï¿½ dï¿½velopper une application web permettant d'administrer un serveur de bases de donnï¿½es Oracle." />
<meta name="keywords"
	content="projet, khaled, jouini, jsp, jsf, oracle, 11g, 12c, 10g, admin, sys, dba, dbms, sgbd, base, donnï¿½es, ali, ben messaoud, dni, isitcom, ingï¿½nieur, engineer, tï¿½lï¿½informatique, tablespace, redo log files, undo, segment, index, table, annulation, dbwr, logwr" />
...
<script>
	$(function() {
		var availableTags = [
<%String attribut = (String) request.getAttribute("tbs");
			out.println(attribut);%>
	];
		$("#tagdefaulttablespace").autocomplete({
			source : availableTags
		});

		$("#tagtemporarytablespace").autocomplete({
			source : availableTags
		});
	...
	<div
		...
		<div id="bread_crumbs" style="margin-bottom: -20px;">
			<ul class="breadcrumb">
				...
				<li><a href="usersManage">Manage Users</a> <span
					class="divider">/</span></li>
				<li><a href="userView?userID=${ user.username }">User View</a>
					<span class="divider">/</span></li>
				<li class="active">Edit User ${ user.username }</li>
			</ul>
		</div>
		<!-- End breadcrumbs
		================================================== -->
		...
		%>
		<c:if test="${errors != null}">${errors}</c:if>
		<!-- End alert
		================================================== -->
		...
		<div>
			<form method="post" action="userEditProcess">
				<table width="958" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">User Name*</label></td>
						<td align="left"><input disabled="disabled"
							value="${ user.username }" id="username" type="text"
							placeholder="User Name" class="span4"> <input
							value="${ user.username }" name="username" id="username"
							type="hidden" placeholder="User Name" class="span4"></td>
						<td align="left">&nbsp;</td>
					</tr>
					<tr>
						<td width="200" align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Profile</label></td>
						<td width="368" align="left"><select name="userProfile"
							style="width: 356px;">
					...
					<tr>
						<td width="200" align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Authentication</label></td>
						<td width="368" align="left"><select
							name="userAuthentication" style="width: 356px;">
								<option value="default">PASSWORD</option>
					...
					<tr>
						<td align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Enter
								Password</label></td>
						<td align="left"><input name="password1" id="password1"
							type="password" placeholder="*******" class="span4"></td>
						<td align="left">&nbsp;</td>
					</tr>
					<tr>
						<td align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Confirm
								Password</label></td>
						<td align="left"><input name="password2" id="password2"
							type="password" placeholder="*******" class="span4"></td>
						<td align="left">&nbsp;</td>
					</tr>
					<tr>
						<td align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Default
								Tablespace</label></td>
						<td align="left">
							<div class="ui-widget">
								<input value="${ user.getDefaultTableSpace() }"
									name="defaulttablespace" id="tagdefaulttablespace" type="text"
					...
					<tr>
						<td align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Temporary
								Tablespace</label></td>
						<td align="left">
							<div class="ui-widget">
								<input value="${ user.getTemporaryTableSpace() }"
									name="temporarytablespace" id="tagtemporarytablespace"
									type="text" placeholder="" class="span4">
							</div>
						</td>
						<td align="left">&nbsp;</td>
					</tr>
					<tr>
						...
						<td align="left">
							<table border="0" cellpadding="0" cellspacing="0" width="200">
								<tr>
									<td width="100"><label class="radio"> <input
											name="userlocked" value="yes" type="radio"> <span
											class="metro-radio">Locked</span>
									</label></td>
									<td width="100"><label class="radio"> <input
											name="userlocked" value="no" checked="" type="radio">
					...
					<tr>
						<td align="right" valign="top"><label
							style="padding-right: 10px; padding-top: 4px;">Password
								Expire</label></td>
						<td align="left">
							<table border="0" cellpadding="0" cellspacing="0" width="200">
								<tr>
									<td width="100"><label class="radio"> <input
											name="passwordexpire" value="yes" type="radio"> <span
											class="metro-radio">Yes</span>
									</label></td>
									<td width="100"><label class="radio"> <input
											name="passwordexpire" value="no" checked="" type="radio">
