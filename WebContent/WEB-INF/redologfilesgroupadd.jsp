...
<title>Manage Redo Logfiles -  Oracle DB Lite Manager : ODBLM</title>
		...
		<div>
			<form method="post" action="redoLogfilesMemberAdd" name="form"
			  ...
			  <table align="center">
			    <tr>
			      <td>Logfile name</td>
			      <td colspan="2"><input type="text" name="file_name" class="input-large"></td>
		        </tr>
			    <tr>
			      <td>Size : </td>
			      <td><input type="text" name="file_size" size="4"></td>
			      <td><select name="file_size_unit" id="file_size_unit">
