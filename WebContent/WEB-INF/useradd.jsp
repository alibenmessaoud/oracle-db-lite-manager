...
<title>Create User · Oracle DB Lite Manager : ODBLM</title>
<meta name="robots" content="noindex, nofollow">
<meta name="description"
	content="Le projet consiste à developper une application web permettant d'administrer un serveur de bases de donnï¿½es Oracle." />
<meta name="keywords"
	...
	<div
		...
		<div id="bread_crumbs" style="margin-bottom: -20px;">
			<ul class="breadcrumb">
				...
				<li><a href="userAdd">Create Users</a> <span class="divider">/</span></li>
				<li class="active">User Process</li>
			</ul>
		</div>
		<!-- End breadcrumbs
		================================================== -->
		...
		<div>
			<form method="post" action="userAddProcess">
				<table width="958" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="left"><input name="username" id="username"
							type="text" placeholder="User Name" class="span4"></td>
						<td align="left">&nbsp;</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="left">
							<div class="ui-widget">
								<input name="defaulttablespace" id="tagdefaulttablespace"
					...
					<tr>
						...
						<td align="left">
							<div class="ui-widget">
								<input name="temporarytablespace" id="tagtemporarytablespace"
									type="text" placeholder="" class="span4">
							</div>
						</td>
						<td align="left">&nbsp;</td>
