...
<title>Manage Users � Oracle DB Lite Manager : ODBLM</title>
...
<link rel="stylesheet" type="text/css"
	href="content/css/DT_bootstrap.css">
	...
	<div
		...
		<div style="padding-bottom: 2px;">
			...
			<div style="display: inline-block; float: right; padding-top: 4px;">
				<a href="userAdd" class="btn btn-primary">Create User</a>
			</div>
		</div>
		<br> <br>
		<div>
		...
		<div>
			<table width="958" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td width="100">Authentication</td>
					<td width="140">Default Tablespace</td>
					<td width="180">Temporary Tablespace</td>
					<td width="148">Status</td>
					<td width="250">Action</td>
				</tr>
				<c:forEach var="user" items="${users}" end="${count-1}">
					<tr>
						<td style="word-wrap: break-word;">${user.getUsername()}</td>
						<td style="word-wrap: break-word;">${user.getAuthentication()}</td>
						<td style="word-wrap: break-word;">${user.getDefaultTableSpace()}</td>
						<td style="word-wrap: break-word;">${user.getTemporaryTableSpace()}</td>
						<td style="word-wrap: break-word;">${user.getStatus()}</td>
						<td><a href="userView?userID=${user.getUsername()}"
							class="btn btn-mini"><i class="icon-book"> </i> View</a> <a
							href="userEdit?userID=${user.getUsername()}" class="btn btn-mini"><i
								class=" icon-pencil icon-small"> </i> Edit</a> <a
							href="userDelete?userID=${user.getUsername()}"
							class="btn btn-mini"><i class="icon-remove"> </i> Delete</a></td>
					</tr>
				</c:forEach>
			</table>
